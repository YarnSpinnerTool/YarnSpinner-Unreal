...
public:
  ...
  explicit constexpr CompilerOutput_StringsEntry_DoNotUse(
...
class YARNSPINNER_API CompilerOutput final :
 ...
 public:
  ...
  explicit constexpr CompilerOutput(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class YARNSPINNER_API Diagnostic final :
 ...
 public:
  ...
  ~Diagnostic() override;
  explicit constexpr Diagnostic(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class YARNSPINNER_API StringInfo final :
 ...
 public:
  ...
  ~StringInfo() override;
  explicit constexpr StringInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void Range::set_allocated_start(::Yarn::Position* start) {
  ...
  if (start) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::Yarn::Position>::GetOwningArena(start);
    if (message_arena != submessage_arena) {
...
inline void Range::set_allocated_end(::Yarn::Position* end) {
  ...
  if (end) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::Yarn::Position>::GetOwningArena(end);
    if (message_arena != submessage_arena) {
...
inline ::Yarn::Diagnostic_Severity Diagnostic::_internal_severity() const {
  return static_cast< ::Yarn::Diagnostic_Severity >(severity_);
}
...
inline void Diagnostic::set_allocated_range(::Yarn::Range* range) {
  ...
  if (range) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::Yarn::Range>::GetOwningArena(range);
    if (message_arena != submessage_arena) {
